        ...
        <div className="wrapper">
            ...
            <p>Social Media: </p>
                ...
                <div className="rounded-full px-2 py-2 border border-slate-700 dark:border-slate-400">
                    <a href="https://x.com/raju100f" className="hover:text-cyan-500"><CiTwitter  className="w-6 h-6"/></a>
                </div>
                </ToolTip>
                <ToolTip text="Github">
                <div className="rounded-full px-2 py-2 border border-slate-700 dark:border-slate-400">
                    <a href="https://github.com/zDarkx1" className="hover:text-slate-500"><IoLogoGithub  className="w-6 h-6"/></a>
                </div>
                </ToolTip>
                <ToolTip text="Linkedin">
                <div className="rounded-full px-2 py-2 border border-slate-700 dark:border-slate-400">
                    <a href="https://www.linkedin.com/in/alrizky-filardhi-budiman/" className="hover:text-blue-500"><IoLogoLinkedin  className="w-6 h-6"/></a>
                </div>
                </ToolTip>
            </div>
